<div class="comments-holder" data-module="broadcast-comments">
	<a href="#" class="comment-form-trigger-link<?if(count($arResult["COMMENTS"])==0):?> hidden<?endif;?>" data-type="comment-form-trigger"><span data-icon="icon-paper-airplane"></span><span>Оставить отзыв</span></a>
	<div class="broadcast-user-comments-form collapse<?if(count($arResult["COMMENTS"])==0):?> in<?endif;?>">
	...
	<div class="broadcast-user-comments collapse<?if(count($arResult["COMMENTS"])>0):?> in<?endif;?>">
		<div class="block-header">
