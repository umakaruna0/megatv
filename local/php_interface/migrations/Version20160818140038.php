...
class Version20160818140038 extends Version {

    protected $description = "Source table props add";
    
    protected $arHlData = array(
        'FIELDS' => array(
            'UF_LINK' => array('N', 'string', array(
    ...
    public function up()
    {
        ...
        $arHlblock = \Bitrix\Highloadblock\HighloadBlockTable::getList(array(
            'filter' => array(
                'TABLE_NAME' => \Hawkart\Megatv\SourceTable::getTableName(),
            ))
        )->fetch();
