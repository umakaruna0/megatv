    ...
    <div class="flex-row user-profile-top-row">
        ...
        <!-- ! ============== Заменено ============== ! -->
                ...
                <form action="/local/components/hawkart/user.profile/templates/.default/ajax.php" class="user-profile-form" data-module="user-profile-form">
                    ...
                    <input type="hidden" name="sessid" id="sessid_2" value="2b35b4ee9717bf1eb6b73f087a056273" />
                    ...
                    <button type="submit" class="btn btn-primary btn-block btn-multistate" data-type="multistate-button"><span class="default-state init-state">Сохранить изменения</span><span class="done-state"><span data-icon="icon-msbutton-checkmark"></span>Изменения сохранены</span>
                    </button>
                </form>
            </div>
        </section>
        <section class="user-passport">
            ...
            <div class="block-body">
                <form action="/local/components/hawkart/user.profile/templates/.default/ajax.php" class="user-passport-form" data-module="user-passport-form">
                    <script type="text/x-config">
                    ...
                    <input type="hidden" name="sessid" id="sessid_3" value="2b35b4ee9717bf1eb6b73f087a056273" />
                    ...
                    <button type="submit" class="btn btn-primary btn-block btn-multistate" data-type="multistate-button"><span class="default-state init-state">Сохранить данные</span><span class="done-state"><span data-icon="icon-msbutton-checkmark"></span>Данные сохранены</span>
                    </button>
                </form>
            </div>
        </section>
            ...
            <div class="block-body">
                <form action="/local/components/hawkart/user.change_password/templates/.default/ajax.php" class="reset-password-form" data-module="reset-password-form">
                    ...
                    <div class="col">
                        ...
                        <button type="submit" class="btn btn-primary btn-block btn-multistate" data-type="multistate-button"><span class="default-state init-state">Сменить пароль</span><span class="done-state"><span data-icon="icon-msbutton-checkmark"></span>Пароль изменён</span>
                        </button>
                    </div>
                </form>
            </div>
